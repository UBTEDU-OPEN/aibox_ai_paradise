...
# -*- coding:utf-8 -*-
#
# File      : facemask_title_widget.py
# Created   : 2020/5/27 5:29 下午
...
class FacemaskTitleWidget(QWidget):
    ...
    def _setup_layout(self):
        ...
        self.tipLabel.setFixedWidth(640)
    ...
    def _init_logo(self):
        ...
        icon = QLabel()
        icon_path = os.path.join(os.path.dirname(__file__), "resource/images", "img_logo.png")
    ...
    def _init_title(self):
        ...
        #英文显示适配
        margin = label.getContentsMargins()
        label.setContentsMargins(margin[0], margin[1], margin[2], margin[3] + 3)
        return label
    ...
    def _init_tip(self):
        ...
        #英文显示适配
        margin = label.getContentsMargins()
        label.setContentsMargins(margin[0], margin[1], margin[2], margin[3] + 2)
        return label
